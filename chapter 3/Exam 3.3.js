// Exam 3.3
// Create a new JavaScript class called Color. It should have a constructor that takes three numbers for RGB color, a string for hexadecimal
// representation and if no parameter passed – default to black.
